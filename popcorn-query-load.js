...
const STORM_RPS_TOTAL = parseInt(__ENV.STORM_RPS_TOTAL || "20", 10);
const STORM_DURATION = __ENV.STORM_DURATION || "30s";
const STORM_SPLIT_MY_ORDER_PCT = parseInt(__ENV.STORM_SPLIT_MY_ORDER_PCT || "35", 10);

const MIX_RPS = parseInt(__ENV.MIX_RPS || "5", 10);
const MIX_DURATION = __ENV.MIX_DURATION || "30s";

const CONSISTENCY_RPS = parseInt(__ENV.CONSISTENCY_RPS || "3", 10);
const CONSISTENCY_DURATION = __ENV.CONSISTENCY_DURATION || "30s";
