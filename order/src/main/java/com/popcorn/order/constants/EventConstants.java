...
public final class EventConstants {
    ...
    public static final class EventTypes {
        ...
        // Order events (order-events stream) - UPPER_SNAKE_CASE
        ...
        // Payment requests (payment-requests stream)
        ...
        // Store requests (store-requests stream)
