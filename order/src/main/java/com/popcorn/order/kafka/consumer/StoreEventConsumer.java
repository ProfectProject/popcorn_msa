...
public class StoreEventConsumer {
    ...
    public void storeReserveConsumer(
        ...
        try {
            ...
            String eventType = payload.get("eventType") == null ? null : payload.get("eventType").toString();
            String orderIdRaw = payload.get("orderId") == null ? null : payload.get("orderId").toString();
